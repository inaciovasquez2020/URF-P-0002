...
from release_boundary_certificate import (
    missing_required_paths,
    release_boundary_certificate,
)
...
def test_release_boundary_certificate_passes_for_manifest() -> None:
    ...
    assert cert.theorem_id == "URFP0002-RBC-1"
...
def test_repository_scope_verifier_passes() -> None:
    ...
    assert '"theorem_id": "URFP0002-RBC-1"' in result.stdout
